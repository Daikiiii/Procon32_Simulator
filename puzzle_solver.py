...
img_path="D:/Python_Script/puzzle/puzzle1.png"
assembled_height=4
assembled_width=10
...
piece_placement = __fill_unused(Block,RotBlock,unused_pieces,assembled_height,assembled_width,weights)
print(piece_placement)
    
solution=__paste_pieces(npieces, Block,RotBlock,assembled_width,assembled_height)
